...
public interface CommonMazeObject {
     ...
     * @return true if object can move in this direction dir, false if object can't
     *         move in this direction dir
     * @exception UnsupportedOperationException default. because not all objects can
     *                                          move
     */
    default boolean canMove(CommonField.Direction dir) {
     ...
     * @return true if object move in this direction dir, false if object can't move
     *         in this direction dir
     * @exception UnsupportedOperationException default, because not all objects can
     *                                          move
     */
    default boolean move(CommonField.Direction dir) {
        throw new UnsupportedOperationException();
    };
     ...
     * @exception UnsupportedOperationException default, because not all objects
     *                                          have points
     */
     ...
     * 
     * @return true if object is pacman, false if object is not pacman. Default
     *         return false
     */
     ...
     * 
     * @return true if object is key, false if object is not key. Default return
     *         false
     */
     ...
     * 
     * @return true if object is point(score), false if object is not point(score).
