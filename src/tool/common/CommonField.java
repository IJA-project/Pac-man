...
/**
 * Interface to the fields that can be placed on the board maze Maze.
 * Commonmazeobjects can be inserted into boxes that allow this. The interface
 * extends the Observable interface-allows you to notify dependent objects
 * (Observable.Observer) about changes made to the field.
 */
